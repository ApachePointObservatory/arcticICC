...
commandList = [
    "set bin=2 window=2,2,400,800 amps=auto filter=2 temp=100",
    "set bin=4 window=2,2,400,800 amps=auto filter=2 temp=100",
    "set bin=1 window=2,2,400,800 amps=auto filter=u temp=100",
    "set bin=0 amps=quad window=0,2,400,800 filter=2 temp=100",
    "set bin=0 window=0,2,400,800 amps=auto filter=2 temp=1e10",
    "set bin=0 window=0,2,400,800 filter=2 amps=ll temp=1E10",
    "set bin=0 window=full amps=auto filter=2 temp=100.6",
    "set bin=1 window=0,0,400,800 amps=auto filter=g temp=100",
    # "set bin=1 amps=auto  window=(0,0,400,800) filter='g' temp=100",
    # "set bin=1 amps=auto  window=[0,0,400,800] filter=\"g\" temp=100",
    "set bin=1 window=full amps=auto filter=r temp=100",
